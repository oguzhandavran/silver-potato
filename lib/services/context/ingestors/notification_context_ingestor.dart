...
class NotificationContextIngestor implements ContextIngestor {
  final AndroidEventChannelIngestor _delegate;

  NotificationContextIngestor(ContextPlatformBridge bridge)
      : _delegate = AndroidEventChannelIngestor(
          id: 'notifications',
          displayName: 'Notifications (WhatsApp/ColorNote/StarNote)',
          eventChannelName: 'com.example.flutter_shell/context_events/notifications',
          bridge: bridge,
        );
